	...
	case 'file':
            $input = "<div class=\"input\">
						<label class=\"input__label-upload\" for=\"uploadFile\">
						  ...
						  <span class=\"input__label-upload-text\">Прикрепить резюме (макс. 10 МБ)</span>
